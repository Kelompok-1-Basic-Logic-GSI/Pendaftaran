...
<div class="row"> 	
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            ...
            <ol>
            	<li>Calon Mahasiswa yang akan mengikuti ujian harus dalam keadaan fit, memakai pakaian yang rapih dan mempersiapkan alat tulis berserta kartu ujian</li>
            	<li>Calon Mahasiswa yang tidak mengikuti peraturan diatas maka akan gugur</li>
            </ol>    

            <h4><b>Biaya yang harus dibayarkan tegantung dari jurusan (Teknik Informatika/Sistem Informasi), kententuan sebagai berikut: </b></h4>
			<ol>
